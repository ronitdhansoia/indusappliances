...
export const stages: Stage[] = [
  {
    ...
    image: "/plant/office-laptop.jpg",
    alt: "An engineer working through a specification on a laptop in the plant office",
    caption: "Plant office",
  },
  {
    name: "Engineering",
    body: "Concepts become drawings, bills of materials and specifications a line can build.",
    image: "/plant/office-desks.jpg",
    alt: "Three colleagues at their workstations in the plant office",
    caption: "Engineering desks",
  },
  {
    name: "Tooling",
    body: "Those ideas become physical production systems, cut in our own tool room on CAD/CAM.",
    image: "/plant/office-desk.jpg",
    alt: "An engineer at a CAD workstation in the plant office",
    caption: "CAD workstation",
  },
  {
    name: "Fabrication",
    body: "Sheet is laser cut, bent on CNC press brakes and powder coated under one roof.",
    image: "/plant/fabrication-line-sign.jpg",
    alt: "Operators at the benches of fabrication line 1, under its sign",
    caption: "Fabrication line 1",
  },
  {
    name: "Assembly",
  ...
  },
  {
    ...
    image: "/plant/hood-final-check.jpg",
  ...
  },
  {
    ...
    image: "/plant/shop-floor.jpg",
    alt: "The dispatch aisle, with packed units and colleagues crossing the floor",
    caption: "Dispatch aisle",
  },
];
...
export const working = {
  items: [
    ...
    },
    {
      ...
      image: "/plant/visitors-floor.jpg",
      alt: "A visiting group with plant leadership on the shop floor",
      caption: "Visitors on the shop floor",
    },
  ],
};
